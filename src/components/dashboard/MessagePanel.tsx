...
import type { ManagerMessage, TargetRole } from '@/types';
...
const MessageCard: React.FC<MessageCardProps> = ({ message, isExpanded, onToggle }) => {
  ...
  return (
    ...
    >
      ...
      {isExpanded && message.result && (
        <div className="px-4 pb-4 pt-0 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="ml-13 pl-13 border-t border-green-200/50 pt-3">
...
export const MessagePanel: React.FC = () => {
  const { messages, sendMessage } = useDashboardStore();
  ...
  return (
    <>
      ...
      {showMessagePanel && (
        <div className="fixed bottom-24 right-6 w-96 max-h-[70vh] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-40 animate-in fade-in slide-in-from-bottom-4 duration-300">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 bg-gray-50">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">管理留言</h2>
